...
public class ComparatorFactory {
  ...
  public static <K> Comparator <ObjectAndDoubleEntry<K>> ObjectAndDoubleEntryBooleanComparatorDescending() {
	    return new Comparator<ObjectAndDoubleEntry<K>>() {
	      @Override
		public int compare(ObjectAndDoubleEntry<K> object1, ObjectAndDoubleEntry<K> object2) {
	  ...
	  public static <K> Comparator <ObjectAndDoubleEntry<K>> ObjectAndDoubleEntryBooleanComparatorAscending() {
	    return new Comparator<ObjectAndDoubleEntry<K>>() {
	      @Override
		public int compare(ObjectAndDoubleEntry<K> object1, ObjectAndDoubleEntry<K> object2) {
	        if (object1.value > object2.value){
