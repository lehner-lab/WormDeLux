...
public class SearchComboBox extends PlainDocument {
	...
	public static String SELECTIONCHANGED = "SearchComboBox selection changed";
	public static String LEFTMOUSECLICK= "LEFT MOUSE CLICK";
	public static String RIGHTMOUSECLICK = "RIGHT MOUSE CLICK";
		...
		comboBox.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (!selecting){
					...
					fireActionEvent(new ActionEvent(this, 1, SELECTIONCHANGED));
				}
				//else
...
//				System.out.println(e.getButton());
				...
				case MouseEvent.BUTTON1: {
					fireActionEvent(new ActionEvent(this, 1, LEFTMOUSECLICK));
					break;
				}
				case MouseEvent.BUTTON3: {
					fireActionEvent(new ActionEvent(this, 1, RIGHTMOUSECLICK));
					break;
				}
				}
			}
	...
	Object getPrototypeValue(JList list) {
		...
		for (int i = 0, n = model.getSize(); i < n; i++) {
			...
			java.awt.Component c = renderer.getListCellRendererComponent(list, value, i, false,
					false);
	...
	private static void createAndShowGUI() {
		...
		JComboBox comboBox = new JComboBox(new Object[] { new TrackedNucleus(), "Ester", "Jordina",
				"Jorge", "Sergi" });
